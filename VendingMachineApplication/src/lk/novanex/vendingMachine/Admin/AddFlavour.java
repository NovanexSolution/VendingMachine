 ...
 * @author Madusanka
 */
public class AddFlavour extends javax.swing.JFrame {
    ...
    private String addFlavor() {
       String msg = "Invalid";
        String flavor = jTextField1.getText().trim();
        
        if (flavor.isEmpty()) {
            msg = "Please Type New Category";
        } else {
            try {
                MySQL.executeIUD("INSERT INTO `flavor` (`flavorName`) VALUES ('"+ flavor +"')");
                msg = "done";
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddFlavour.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddFlavour().setVisible(true);
            }
        });
    }
